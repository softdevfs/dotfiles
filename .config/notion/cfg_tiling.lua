...
defbindings("WTiling", {
    ...
    kpress(META.."Shift+j", "WTiling.split_at(_, _sub, 'right', true)"),

	bdoc("Split current into columns.", "hsplit"),
    kpress(META.."Shift+k", "WTiling.split_at(_, _sub, 'left', true)"),

    bdoc("Split current into rows.", "vsplit"),
    kpress(META.."Shift+h", "WTiling.split_at(_, _sub, 'bottom', true)"),

    bdoc("Split current into rows.", "vsplit"),
    kpress(META.."Shift+l", "WTiling.split_at(_, _sub, 'top', true)"),
    ...
    kpress(ALTMETA.."I", "ioncore.goto_next(_sub, 'down', {no_ascend=_})"),
    bdoc("Go to frame above current frame.", "^frame"),
    kpress(META.."I", "ioncore.goto_next(_sub, 'up', {no_ascend=_})"),
})

-- Frame bindings.
defbindings("WFrame.floating", {
    bdoc("Tile frame, if no tiling exists on the workspace", "tile"),
    kpress(META.."Shift+B", "mod_tiling.mkbottom(_)"),
})
